...
namespace UpworkPlatesLookupAutomationDLL
{
    public class PlateLookupAutomation
    {
        ...
        public string user { get; set; } = "salessupport@jbrcapital.com";
        public string password { get; set; } = "MClarenP1!34";
        ...
        {
            if (br.DocumentText.Contains("no insurance details have been found on the MID."))
            {
                Callback(null);
            }
            else
