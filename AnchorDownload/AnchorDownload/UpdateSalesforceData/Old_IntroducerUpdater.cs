    ...
    class IntroducerUpdater
    {
        ...
        public static void UpdateAccountData(SqlConnection sqlConn, SalesforceHttpClient salesforceClient)
        {
            ...
            while (AccountData.Read())
            {
                ...
                updateIntroducerRecordInSalesforce(salesforceClient, AccountDataForSF);
        ...
        private static void updateIntroducerRecordInSalesforce(SalesforceHttpClient salesforceClient, AccountData AccountData)
        {
            //try
            //{
