...
namespace CallCreditApiDelegation.Helpers
{
    public class DataHelper
    {
        ...
        public async static Task<ForceClient> GetSalesforceConnection(SalesforceCredentials salesforceCredentials)
        {
            ...
            await auth.UsernamePasswordAsync(
                salesforceCredentials.ConsumerKey, 
                salesforceCredentials.ConsumerSecret, 
                salesforceCredentials.Username, 
                salesforceCredentials.Password + salesforceCredentials.SecurityToken);
