...
namespace UpdateSalesforceData
{
    public static class AgreementUpdater
    {
        ...
        public static void UpdateAgreementData()
        {
            Console.WriteLine(string.Concat("Started Sync of Agreements"));

            introducersAndDealers = getIntroducerAndSupplierRecordsFromSalesforce(Program.salesforceClient);
            ILookup<string, string> salesforceUserIds = GetSalesforceUserIds(Program.salesforceClient);

            var dateTimeSyncStarted = DateTime.Now;

            Program.salesforceClient.BulkUpsertFromSQL("Agreement__c", "sentinalProposal_Id__c",
                GetAgreementDataFromSQL, agreementData => 
                    new SObject()
                    {
                        ...
                        { "approval_agreementNumber__c", agreementData["AgreementNumber"].ToString().Trim() },
                        { "totalCashPrice__c", DataHelper.GetDouble(agreementData["TotalCashPrice"].ToString().Trim()) },
                        { "calcVehicleValue__c", DataHelper.GetDouble(agreementData["CalcVehicleValue"].ToString().Trim()) },
                       ...
                       // { "workDayPayDate__c" , DataHelper.GetDateTime(agreementData["WorkDayPayDate"])},
                        ...
                        { "introduction_introducer_name__c", "test" },// DataHelper.GetString(agreementData["Introducer"])},
                        ...
                        { "introduction_supplier_name__c", "test" },//DataHelper.GetString(agreementData["Dealer"])},
                        { "supplier_commissionAmount__c" , DataHelper.GetDouble(agreementData["DealerCommission"])},
                        { "introduction_introducerChannel__c" , agreementData["IntroducerChannel"].ToString().Trim()},
                        ...
                        { "make__c" , agreementData["Make"].ToString().Trim()},
                        { "model__c" , agreementData["Model"].ToString().Trim()},
                        { "vehicleType__c" , agreementData["VehicleType"].ToString().Trim()},
                        { "introduction_jbrSalesman__c" , salesforceUserIds[agreementData["JBRSalesmanNumber"].ToString().Trim()].FirstOrDefault()},
                        { "introduction_jbrSalesmanName__c" , agreementData["JBRSalesmanName"].ToString().Trim()},
                        ...
                        { "customersAndCompanyNames__c" , agreementData["CustomerAndCompanyNames"].ToString().Trim()},
            ...
            UpdateLastTimeAgreementsWereUpdated(dateTimeSyncStarted, Program.sqlConn);
