...
//            Task.Run(async () =>
//            {
//                anchorWebServices = await Program.salesforceClient.QueryAsync<VehicleData>(queryString);
...
//                        successResponse = await Program.salesforceClient.UpdateAsync("ProposalVehicle__c", proposalVehicle.id, updatedVehicle);
//                        successResponse = await Program.salesforceClient.UpdateAsync("Vehicle__c", proposalVehicle.vehicle__c, updatedVehicle);
